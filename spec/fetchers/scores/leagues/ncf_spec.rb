...
describe SportsApi::Fetcher::Score::NCF do
  ...
  describe '#find' do
    describe 'pregame' do
      ...
      before { expect_any_instance_of(SportsApi::Fetcher::Score::NCF).to receive(:scoreboard).with('football', 'college-football', week: week, limit: 300, groups: 80).and_return(json_stub) }
