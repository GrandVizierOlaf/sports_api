...
describe SportsApi::Fetcher::Score::MLB do
  describe '#find' do
    describe 'past game' do
      ...
      before { expect_any_instance_of(SportsApi::Fetcher::Score::MLB).to receive(:scoreboard).with('baseball', 'mlb', dates: 20150809).and_return(json_stub) }
    ...
    describe 'pregame' do
      ...
      before { expect_any_instance_of(SportsApi::Fetcher::Score::MLB).to receive(:scoreboard).with('baseball', 'mlb', dates: 20150810).and_return(json_stub) }
