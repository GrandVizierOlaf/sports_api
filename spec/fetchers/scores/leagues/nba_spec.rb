...
describe SportsApi::Fetcher::Score::NBA do
  describe '#find' do
    context 'past game' do
      ...
      before { expect_any_instance_of(SportsApi::Fetcher::Score::NBA).to receive(:scoreboard).with('basketball', 'nba', dates: 20151027).and_return(json_stub) }
    ...
    describe 'pregame' do
      ...
      before { expect_any_instance_of(SportsApi::Fetcher::Score::NBA).to receive(:scoreboard).with('basketball', 'nba', dates: 20151101).and_return(json_stub) }
      context 'event info' do
